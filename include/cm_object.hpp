 ...
 *
 * Lifecycle:
 *   Construction: registers Progress at NotStarted.
 *   execute():    sets InProgress (start_time stamped), drives handler,
...
class CMObject : public sdbusplus::async::server_t<CMObject, ProgressAServer>
{
  public:
    ...
    /** @brief Expose context for use by coroutines in this class. */
